...
ggplot(db_sum) +
  ...
  annotate("text",x=as.Date("2020-08-25"), y=38, label="End of quarantine", colour="black", angle=0,size=5,hjust=-0.04)
ggsave(here(paste0("views/Fig3d.pdf")),height=6,width=10)
